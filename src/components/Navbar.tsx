...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${showSolidNavbar
    ...
    >
      ...
      <div
        className={`lg:hidden fixed top-0 right-0 z-50 w-full h-[100dvh] bg-[#FAF8F3] shadow-2xl transition-transform duration-500 ease-in-out ${menuOpen
          ? "translate-x-0 pointer-events-auto"
          : "translate-x-full pointer-events-none"
          }`}
      >
        <div className="px-5 py-[85px] overflow-y-auto h-full">
